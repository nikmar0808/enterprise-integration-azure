...
resource "azurerm_linux_virtual_machine" "uat" {
  name                            = "eai-uat-host"
  ...
  # (.venv) PS C:\enterprise-integration-azure\infra\prod>
...
resource "azurerm_virtual_machine_extension" "aad_login" {
  ...
  virtual_machine_id         = azurerm_linux_virtual_machine.uat.id
...
output "vm_id"       { value = azurerm_linux_virtual_machine.uat.id }
